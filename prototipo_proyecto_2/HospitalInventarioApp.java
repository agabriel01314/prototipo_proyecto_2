...
public class HospitalInventarioApp {
    public static void main(String[] args) throws IOException{
        ...
        InicioSesion inicioSesion = new InicioSesion(registro ) ;
        ...
        while (continuar) {
            ...
            //scan.nextLine(); // consumir el buffer del scan para que no de error 
            ...
            switch (option){
                ...
                case "3" :
                    ...
                    // cuando no es correcta la opción que ingrese el usuario 
                default:
